...
public class StoreSpinnerAdapter extends ArrayAdapter<Store> {
    ...
    public StoreSpinnerAdapter(Context context, List<Store> objects, final EditShelfFragment editShelfFragment) {
                    ...
                    new AlertDialog.Builder(context)
                            ...
                            .setPositiveButton(context.getString(R.string.yes), new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    ((ShelfieFragmentListener) context).reinitFragments();
                                }
                            })
