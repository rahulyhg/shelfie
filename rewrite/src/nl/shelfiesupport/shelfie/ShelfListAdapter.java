...
class ShelfListAdapter extends ArrayAdapter<ShelfItem> {
    ...
    private class SelectClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            editShelfFragment.shelf.setSelectedItem(item);
    ...
    public ShelfListAdapter(Context context, List<ShelfItem> objects, EditShelfFragment editShelfFragment) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            shelfItemRowLayout = new ShelfItemRowLayout(context, editShelfFragment);
        } else {
